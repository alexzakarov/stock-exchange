...
// IndicatorSma100 Indicator Calculate Func
func (u *service) IndicatorSma100(ctx context.Context, chartData []binance.ChartData) (responser ent.IndicatorCalcResponse, err error) {
	if u.cfg.Server.APP_DEBUG == true {
		println("IndicatorSma100 begin to work")
	}
