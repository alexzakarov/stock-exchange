...
// IndicatorSma50 Indicator Calculate Func
func (u *service) IndicatorSma50(ctx context.Context, chartData []binance.ChartData) (responser ent.IndicatorCalcResponse, err error) {
	if u.cfg.Server.APP_DEBUG == true {
		println("IndicatorSma50 begin to work")
	}
