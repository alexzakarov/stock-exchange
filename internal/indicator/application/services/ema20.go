...
// IndicatorEma20 Indicator Calculate Func
func (u *service) IndicatorEma20(ctx context.Context, chartData []binance.ChartData) (responser ent.IndicatorCalcResponse, err error) {
	if u.cfg.Server.APP_DEBUG == true {
		println("IndicatorEma20 begin to work")
	}
