...
// IndicatorEma200 Indicator Calculate Func
func (u *service) IndicatorEma200(ctx context.Context, chartData []binance.ChartData) (responser ent.IndicatorCalcResponse, err error) {
	if u.cfg.Server.APP_DEBUG == true {
		println("IndicatorEma200 begin to work")
	}
