...
// IndicatorSma200 Indicator Calculate Func
func (u *service) IndicatorSma200(ctx context.Context, chartData []binance.ChartData) (responser ent.IndicatorCalcResponse, err error) {
