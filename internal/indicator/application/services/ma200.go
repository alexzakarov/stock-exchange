...
// IndicatorMa200 Indicator Calculate Func
func (u *service) IndicatorMa200(ctx context.Context, chartData []binance.ChartData) (responser ent.IndicatorCalcResponse, err error) {
	if u.cfg.Server.APP_DEBUG == true {
		println("IndicatorMa200 begin to work")
	}
